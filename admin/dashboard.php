...
<head>
    ...
    <title>TJ Archade Hostel Management</title>
    <!-- Custom CSS -->
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                ...
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <span class="opacity-7 text-muted"><i class="fa fa-user-plus" aria-hidden="true" style="font-size:30px;color:#8971ea"></i>
</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                ...
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <span class="opacity-7 text-muted"><i class='fas fa-bed'style="font-size:32px;color:#8971ea" ></i>
</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                ...
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <span class="opacity-7 text-muted"><i class='fas fa-graduation-cap' style='font-size:32px;color:#8971ea'></i>
</span>
                                </div>
                            </div>
                        </div>
