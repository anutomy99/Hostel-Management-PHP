    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
             ...
             <hr>
             <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Parent Details</h4><br>
             ...
             <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Parent Name</h4>
                                        <div class="form-group">
                                            <input type="text" name="pname" id="pname" placeholder="Enter Parent Name" required class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Parent Contact Number</h4>
                                        <div class="form-group">
                                            <input type="text" name="pcontact" id="Pcontact" placeholder="Enter Parent Number" required class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Parent Address</h4>
                                <textarea rows="1" cols="40" name="paddress" id="paddress"></textarea>
                                    <div class="form-group">
                                    </div>
