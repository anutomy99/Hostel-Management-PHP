        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Register a complaint</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Contact No</h4>
                                        <div class="form-group">
                                            <input type="number" name="contactno" id="contactno" placeholder="Enter Contact Number" required="required" class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div> -->
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <textarea rows="1" cols="50" name="complaint" id="complaint"></textarea>
                                    <div class="form-group">
                                    </div>
